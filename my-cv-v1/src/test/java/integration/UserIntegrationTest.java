...
public class UserIntegrationTest {
	...
	static ExtentReports report = new ExtentReports(
			"C:\\Users\\Admin\\Desktop\\ANOTHER ONE\\User Integration Test Results.html");;
	ExtentTest test;
	...
	public void findingAllUsersFromDatabase() throws Exception {
		test = report.startTest("Finding All Users in Database");
		...
		if (mvc.perform(get("/api/user").contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse()
				.getContentAsString().contains("Jon") == true
				&& mvc.perform(get("/api/user").contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse()
						.getContentAsString().contains("Tom") == true) {
	...
	public void findingAUserFromDatabase() throws Exception {
		test = report.startTest("Finding a User in Database");
		DepartmentModel department = new DepartmentModel("Big Boss");
		departmentRepo.save(department);
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
		userRepo.save(new UsersDataModel("Jon", "Snow", "js@gmail.com", "password", department));
		...
		if (mvc.perform(get("/api/user/" + userId).contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse()
				.getContentAsString().contains("Jon") == true) {
	...
	public void editAUserInDatabase() throws Exception {
		test = report.startTest("Editing a user in the Database");
		DepartmentModel department = new DepartmentModel("Big Boss");
		departmentRepo.save(department);
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
		userRepo.save(new UsersDataModel("Jon", "Snow", "js@gmail.com", "password", department));
		...
		if (mvc.perform(get("/api/user/" + userId).contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse()
				.getContentAsString().contains("Kilua") == true) {
	...
	public void createAUserInDatabase() throws Exception {
		test = report.startTest("Adding a User To Database");
		DepartmentModel department = new DepartmentModel("Big Boss");
		departmentRepo.save(department);
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
	...
	public void getAUserByName() throws Exception {
		test = report.startTest("Finding a user by name");
		DepartmentModel department = new DepartmentModel("Big Boss");
		departmentRepo.save(department);
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
		userRepo.save(new UsersDataModel("Jon", "Snow", "js@gmail.com", "password", department));
		...
		if (mvc.perform(get("/api/findbyname/" + name + "&" + lastName).contentType(MediaType.APPLICATION_JSON))
				.andReturn().getResponse().getContentAsString().contains("Jon") == true) {
	...
	public void getAllUsersInADepartment() throws Exception {
		test = report.startTest("Finding a user by department");
		DepartmentModel department = new DepartmentModel("Big Boss");
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
		...
		if (mvc.perform(get("/api/department/" + dept2Id + "/user").contentType(MediaType.APPLICATION_JSON)).andReturn()
				.getResponse().getContentAsString().contains("Will") == true) {
	...
	public void getAUserByEmailAndPassword() throws Exception {
		test = report.startTest("Finding a user by email and verifying password");
		DepartmentModel department = new DepartmentModel("Big Boss");
		departmentRepo.save(department);
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
		userRepo.save(new UsersDataModel("Jon", "Snow", "js@gmail.com", "password", department));
		...
		if (mvc.perform(get("/api/login/" + email + "&" + password).contentType(MediaType.APPLICATION_JSON)).andReturn()
				.getResponse().getContentAsString().contains("Jon") == true) {
	...
	public void deleteAUser() throws Exception {
		test = report.startTest("Deleting a user from the database");
		DepartmentModel department = new DepartmentModel("Big Boss");
		departmentRepo.save(department);
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
		userRepo.save(new UsersDataModel("Jon", "Snow", "js@gmail.com", "password", department));
		...
		if (mvc.perform(get("/api/user/" + userId).contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse()
				.getContentAsString().contains("Jon") == false) {
	...
	public void updateAUsersDepartment() throws Exception {
		test = report.startTest("Updating the users department");
		DepartmentModel department = new DepartmentModel("Big Boss");
		test.log(LogStatus.INFO, "Created a Department With the Name 'Big Boss'");
		DepartmentModel department2 = new DepartmentModel("Little Boss");
		test.log(LogStatus.INFO, "Created a Department With the Name 'Little Boss'");
		...
		if (mvc.perform(get("/api/user/" + userId).contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse()
				.getContentAsString().contains("Little Boss") == true) {
